  ...
  [Contracts_ATC.DebtToken.STOCK_1]: {
    ...
    troveMintedAmount: {
      fetch: async (fetchSource?: { troveManagerContract: TroveManager; borrower: AddressLike }) => {
        ...
        SchemaDataFreshnessManager_ATC.DebtToken[Contracts_ATC.DebtToken.STOCK_1].troveMintedAmount.value(tokenAmount);
      },
      value: makeVar(defaultFieldValue),
      lastFetched: 0,
      timeout: 1000 * 2,
    ...
    providedStability: {
      fetch: async (fetchSource?: { stabilityPoolManagerContract: StabilityPoolManager; depositor: AddressLike }) => {
        ...
        SchemaDataFreshnessManager_ATC.DebtToken[Contracts_ATC.DebtToken.STOCK_1].providedStability.value(tokenAmount);
      },
      value: makeVar(defaultFieldValue),
      lastFetched: 0,
      timeout: 1000 * 2,
