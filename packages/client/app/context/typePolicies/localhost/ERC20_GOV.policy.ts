  ...
  [Contracts_Localhost.ERC20.GOV]: {
    ...
    troveLockedAmount: {
      fetch: async (fetchSource?: { troveManagerContract: TroveManager; borrower: AddressLike }) => {
        ...
        if (tokenAmount) {
          SchemaDataFreshnessManager_LOCALHOST.ERC20[Contracts_Localhost.ERC20.GOV].troveLockedAmount.value(
            tokenAmount,
          );
        }
      },
    ...
    collSurplusAmount: {
      fetch: async (fetchSource?: { collSurplusContract: CollSurplusPool; depositor: AddressLike }) => {
        ...
        if (tokenAmount) {
          SchemaDataFreshnessManager_LOCALHOST.ERC20[Contracts_Localhost.ERC20.GOV].collSurplusAmount.value(
            tokenAmount,
          );
        }
      },
