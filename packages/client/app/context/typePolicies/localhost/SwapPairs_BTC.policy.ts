  ...
  [Contracts_Localhost.SwapPairs.BTC]: {
    ...
    pendingRewards: {
      fetch: async (stakingOperationsContract: StakingOperations, address: string) => {
        SchemaDataFreshnessManager_LOCALHOST.SwapPairs[Contracts_Localhost.SwapPairs.BTC].pendingRewards.lastFetched =
          Date.now();
        ...
        SchemaDataFreshnessManager_LOCALHOST.SwapPairs[Contracts_Localhost.SwapPairs.BTC].pendingRewards.value(
          pendingRewards,
        );
      },
      value: makeVar(defaultFieldValue),
