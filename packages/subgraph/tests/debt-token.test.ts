...
describe('handleTransfer()', () => {
  ...
  test('handleUpdateDebtTokenMeta_totalSupplyUSD30dAverage is called and the average is correctly calculated', () => {
    const event = createTransferEvent(MockUserAddress, MockSecondUserAddress, oneEther);
    ...
    assert.fieldEquals('TotalSupplyAverage', averageEntityId, 'value', oneEther.times(BigInt.fromI32(100)).toString());
  });

  test('handleUpdateDebtTokenMeta_totalSupplyUSD30dAverage is called and the average is correctly accumulated in one chunk', () => {
    const event = createTransferEvent(MockUserAddress, MockSecondUserAddress, oneEther);
    ...
    const secondEvent = createTransferEvent(MockUserAddress, MockSecondUserAddress, oneEther.times(BigInt.fromI32(2)));
  ...
  test('handleUpdateDebtTokenMeta_totalSupplyUSD30dAverage is called and the average is correctly accumulated in two chunks', () => {
    const event = createTransferEvent(MockUserAddress, MockSecondUserAddress, oneEther);
  ...
  test('handleUpdateDebtTokenMeta_totalSupplyUSD30dAverage: push out old value after 30 days', () => {
